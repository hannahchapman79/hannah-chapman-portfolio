   ...
   return (
      ...
      <div className='intro-card-div'>
         <section className='intro-card'>
            ...
            <h2 className='personal-profile-intro'>I am a developer with a background in e-commerce, having worked across various industries where I saw firsthand the impact of well-crafted code on transforming business performance and user experience. This sparked my passion for bringing ideas to life through software development while using my love for continuous learning, critical thinking, and problem-solving.</h2>
         </section>
      </div>
         <SocialIcons/>
         </div>
